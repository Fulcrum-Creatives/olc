...
<section class="content__wrapper row fp-boxes">
  ...
  fcwp_display_box( 
    'advocacy',
    $olc_box_one_url, 
    $olc_box_one_icon['url'], 
    $olc_box_one_icon_retina['url'], 
    $olc_box_one_icon_svg['url'], 
    $olc_box_one_icon['alt'], 
    $olc_box_one_heading, 
    $olc_box_one_text 
  );
  fcwp_display_box( 
    'education',
    $olc_box_two_url, 
    $olc_box_two_icon['url'], 
    $olc_box_two_icon_retina['url'], 
    $olc_box_two_icon_svg['url'], 
    $olc_box_two_icon['alt'], 
    $olc_box_two_heading, 
    $olc_box_two_text 
  );
  fcwp_display_box( 
    'membership',
    $olc_box_three_url, 
    $olc_box_three_icon['url'], 
    $olc_box_three_icon_retina['url'], 
    $olc_box_three_icon_svg['url'], 
    $olc_box_three_icon['alt'], 
